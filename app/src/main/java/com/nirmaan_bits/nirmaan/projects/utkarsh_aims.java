...
public class utkarsh_aims extends AppCompatActivity implements utkarsh_aims_adapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new utkarsh_aims_adapter(utkarsh_aims.this, list);
        recyclerView.setAdapter(adapter);
        adapter.setOnItemClickListener(utkarsh_aims.this);
        ...
        fb_achievements.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(utkarsh_aims.this,add_aims.class);
...
//    }
    ...
    public void onEditClick(int position){
        //if(MainActivity.if_pl == 1 && ProjectsFragment.project == MyFirebaseSrevice.userProp){
            Intent intent = new Intent(utkarsh_aims.this,edit_aims.class);
