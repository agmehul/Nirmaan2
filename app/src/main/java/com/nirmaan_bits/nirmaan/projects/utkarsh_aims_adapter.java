...
public class utkarsh_aims_adapter extends RecyclerView.Adapter<utkarsh_aims_adapter.ContactViewHolder> {
    Context context;
    List<ach> achs;
    private  utkarsh_aims_adapter.OnItemClickListener mListener;
    ...
    boolean excom = false;
    public utkarsh_aims_adapter(Context context, List<ach> TempList) {
    ...
    @NonNull
    @Override
    public utkarsh_aims_adapter.ContactViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.aim_layout, parent, false);

        utkarsh_aims_adapter.ContactViewHolder viewHolder = new utkarsh_aims_adapter.ContactViewHolder(view);

        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull final utkarsh_aims_adapter.ContactViewHolder holder, final int position) {
...
public interface OnItemClickListener {
    ...
    public  void setOnItemClickListener(utkarsh_aims_adapter.OnItemClickListener listener) {
        mListener = listener;
    }
